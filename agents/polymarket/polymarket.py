...
class Polymarket:
    def __init__(self) -> None:
        ...
        self.usdc_address = "0x3c499c542cEF5E3811e1192ce70d8cC03d5c3359"  # New USDC contract on Polygon
    ...
    def get_usdc_balance(self) -> float:
        ...
        print("Balance res:", balance_res)
        return float(balance_res / 10**6)  # USDC has 6 decimals
